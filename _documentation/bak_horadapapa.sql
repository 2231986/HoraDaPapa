...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 14-Out-2023 às 09:30
...
--
-- Estrutura da tabela `dinner_table`
--

DROP TABLE IF EXISTS `dinner_table`;
CREATE TABLE IF NOT EXISTS `dinner_table` (
...
CREATE TABLE IF NOT EXISTS `plate` (
  ...
  `description` int NOT NULL COMMENT 'descrição do prato',
...
(1, 'Dinis', 'PX_gKI3xzdf7_zaB4vsarW8MUF7XehBY', '$2y$13$nUExg2ntMJ.t7kgJSQnR4ulYxlUJVNwZAe.bT3qEryb1XjpQggfUG', NULL, '2231986@my.ipleiria.pt', 10, 1696447610, 1696447610, 'IxWSJws9jXIM2nq8ABykTlZkrPwK5fHK_1696447610');
...
--
ALTER TABLE `meal`
  ADD CONSTRAINT `fk_dinner_table` FOREIGN KEY (`dinner_table_id`) REFERENCES `dinner_table` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
